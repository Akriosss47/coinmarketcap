...
global_url = 'http://api.coinmarketcap.com/v2/global/?convert=' + convert
...
while True:
    ...
    ticker_url = 'http://api.coinmarketcap.com/v2/ticker/?structure=array&sort='
    ...
    for currency in data:
        ...
        table.add_row([rank,name + '('+symbol +')','$' + str(price),'$' +str(market_cap),'$' +volume_string,str(hour_change),str(day_change),str(week_change)])
